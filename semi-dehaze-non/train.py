...
from trainer_semi import Trainer_semi
...
if checkpoint.ok:
    ...
    if args.model == 'semi_dehaze':
        ...
        t = Trainer_semi(args, dataloader_train, net, ema_net, loss, checkpoint)
        test = Trainer_semi(args, dataloader_test, net, ema_net, loss, checkpoint)
