...
parser.add_argument('--labeled_bs', type=int, default=5, help='labeled_batch_size per gpu')
parser.add_argument('--valBatchSize', type=int, default=1, help='input batch size')
parser.add_argument('--phase', type=str, default='train', help='train, val, test, etc')
parser.add_argument('--dataroot', type=str, default='dataset/Haze4K/train',
                    help='dataset directory')
parser.add_argument('--unlb_dataroot', type=str, default='dataset/domain/unlabeled/unlabeled',
                    help='unlabeled dataset directory')
parser.add_argument('--unlb_depthroot', type=str, default='dataset/domain/unlabeled_depth',
                    help='unlabeled dataset directory')
parser.add_argument('--testpath', type=str, default='dataset/SOTS/all/scale_8',#dataset/SOTS/outdoor
                    help='dataset directory for testing')
parser.add_argument('--model_sava_dirName',type=str,default='model_SOTS')
...
parser.add_argument('--nAveGrad', type=int, default=10)  #16
...
parser.add_argument('--model', default='semi_dehaze',
                    help='model name')
...
parser.add_argument('--save', type=str, default='semi_dehaze',
...
parser.add_argument('--pre_train_dual', type=str, default='experiment/all_result_1025/model/epoch453.pt',
